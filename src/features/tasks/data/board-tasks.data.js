...
export const INITIAL_TASKS = [
  ...
  {
    id: 'task-9',
    title: 'Client onboarding call — Nimbus Corp',
    description: 'Walk the new client through platform setup and answer implementation questions.',
    assignedTo: 'EMP-042',
    priority: 'high',
    status: 'in_progress',
  ...
  },
  {
    ...
    description: "Compile and submit this week's travel and client-entertainment expenses.",
    assignedTo: 'EMP-042',
    priority: 'low',
    status: 'todo',
    dueDate: dateOffset(0),
  ...
  {
    id: 'task-11',
    title: 'Review contract redlines for Sec. 4.2',
    description: "Confirm legal's redline edits align with the agreed SOW terms.",
    assignedTo: 'EMP-042',
    priority: 'medium',
    status: 'completed',
    dueDate: dateOffset(0),
  ...
  {
    id: 'task-12',
    title: 'Prepare vendor comparison sheet',
    description: 'Compare hosting vendor quotes for renewal.',
    assignedTo: 'EMP-042',
    priority: 'medium',
    status: 'todo',
